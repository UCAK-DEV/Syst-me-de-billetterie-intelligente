                  ...
                  audits.map((a) => (
                    <tr key={a.id} className="table-row">
                      <td className="table-td">
                        ...
                        <div className="titre-meta">{new Date(a.createdAt).toLocaleTimeString()}</div>
                      </td>
                      <td className="table-td">
                        <div className="table-td-id">{a.utilisateurId.substring(0, 10)}...</div>
                  ...
                  <tr>
                    <td colSpan="6" className="table-empty-cell">
                      {search || actionFilter || dateFilter
                        ...
                        : "Aucune action sensible enregistrée pour l'instant — la génération, l'activation et la désactivation d'un titre apparaîtront ici automatiquement."}
                    </td>
                  </tr>
                )}
              </tbody>
